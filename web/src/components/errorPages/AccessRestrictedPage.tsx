  ...
  return (
    <ErrorPageLayout>
      ...
      <div className="space-y-4 text-gray-600 dark:text-gray-300">
        <p>
          We regret to inform you that your access to Alvio has been temporarily
          suspended due to a lapse in your subscription.
        </p>
        <p>
          To reinstate your access and continue benefiting from Alvio&apos;s
        ...
        <p>
          ...
          <a
            ...
            href="https://join.slack.com/t/alvio/shared_invite/zt-1w76msxmd-HJHLe3KNFIAIzk_0dSOKaQ"
            target="_blank"
