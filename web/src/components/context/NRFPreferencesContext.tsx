...
interface NRFPreferencesContextValue {
  ...
  useAlvioAsNewTab: boolean;
  setUseAlvioAsNewTab: (v: boolean) => void;
...
export function NRFPreferencesProvider({
  ...
  const [useAlvioAsNewTab, setUseAlvioAsNewTab] = useLocalStorageState<boolean>(
    LocalStorageKeys.USE_ALVIO_AS_NEW_TAB,
    true
  );
