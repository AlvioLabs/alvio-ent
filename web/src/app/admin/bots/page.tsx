  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to Alvio. Once setup, you will be able to
        ask questions to Alvio directly from Slack. Additionally, you can:
      </p>

      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup AlvioBot to automatically answer questions in certain channels.
          </li>
          <li>
            Choose which document sets AlvioBot should answer from, depending on
            the channel the question is being asked.
          </li>
          <li>
            Directly message AlvioBot to search just as you would in the web UI.
          </li>
        </ul>
      </div>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        <a
          ...
          href="https://docs.alvio.io/admin/getting_started/slack_bot_setup"
          target="_blank"
          rel="noopener noreferrer"
        >
          guide{" "}
        </a>
        found in the Alvio documentation to get started!
      </p>
