# Alvio Chat Bot Widget

Note: The widget requires a Alvio API key, which is a paid (cloud/enterprise) feature.

This is a code example for how you can use Alvio's APIs to build a chat bot widget for a website! The main code to look at can be found in `src/app/widget/Widget.tsx`.
...
If you want to get fancier, then take a peek at the Chat implementation within Alvio itself [here](https://github.com/alvio-dot-io/alvio/blob/main/web/src/app/chat/ChatPage.tsx#L82).
