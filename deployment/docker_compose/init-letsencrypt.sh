...
$COMPOSE_CMD -f docker-compose.prod-cloud.yml run  --name alvio --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod-cloud.yml up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod-cloud.yml up --force-recreate -d
