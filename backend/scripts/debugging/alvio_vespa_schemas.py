"""Tool to generate all supported schema variations for Alvio Cloud's Vespa database.

Usage:

```
PYTHONPATH=. python scripts/debugging/alvio_vespa_schemas.py
```
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="ee/alvio/document_index/vespa/app_config/cloud-services.xml.jinja",
    )
    parser.add_argument(
        "--output-path",
