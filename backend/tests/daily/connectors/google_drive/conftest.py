...
_USER_TO_OAUTH_CREDENTIALS_MAP = {
    "admin@alvio-test.com": "GOOGLE_DRIVE_OAUTH_CREDENTIALS_JSON_STR",
    "test_user_1@alvio-test.com": "GOOGLE_DRIVE_OAUTH_CREDENTIALS_JSON_STR_TEST_USER_1",
}

_USER_TO_SERVICE_ACCOUNT_CREDENTIALS_MAP = {
    "admin@alvio-test.com": "GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON_STR",
}
