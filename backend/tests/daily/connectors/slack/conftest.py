...
def slack_connector(
    ...
    slack_credentials_provider: AlvioStaticCredentialsProvider,
...
@pytest.fixture
def slack_credentials_provider() -> AlvioStaticCredentialsProvider:
    CI_ENV_VAR = "SLACK_BOT_TOKEN"
    LOCAL_ENV_VAR = "ALVIO_BOT_SLACK_BOT_TOKEN"
    ...
    return AlvioStaticCredentialsProvider(
