...
from alvio.connectors.gmail.connector import _build_time_range_query
from alvio.connectors.gmail.connector import thread_to_document
...
def test_thread_to_document() -> None:
    ...
    doc = thread_to_document(full_email_thread, "admin@alvio-test.com")
