...
# from alvio.chat.models import AlvioAnswerPiece
...
# from alvio.tools.models import ToolCallKickoff
...
# from tests.unit.alvio.chat.conftest import DEFAULT_SEARCH_ARGS
# from tests.unit.alvio.chat.conftest import QUERY
...
# ) -> Answer:
#     mocker.patch(
#         "alvio.chat.answer.fast_gpu_status_request",
#         return_value=True,
#     )
...
#     assert len(output) == 2
#     assert isinstance(output[0], AlvioAnswerPiece)
#     assert isinstance(output[1], AlvioAnswerPiece)

#     full_answer = "".join(
#         piece.answer_piece
#         for piece in output
#         if isinstance(piece, AlvioAnswerPiece) and piece.answer_piece is not None
#     )
...
#     )
#     assert output[3] == AlvioAnswerPiece(answer_piece="Based on the search results, ")
#     expected_citation = CitationInfo(citation_num=1, document_id="doc1")
#     assert output[4] == expected_citation
#     assert output[5] == AlvioAnswerPiece(
#         answer_piece="the answer is abc[[1]](https://example.com/doc1). "
#     )
#     assert output[6] == AlvioAnswerPiece(answer_piece="This is some other stuff.")
...
#     assert len(output) == 3
#     assert output[0] == AlvioAnswerPiece(answer_piece="This is the ")
#     assert output[1] == AlvioAnswerPiece(answer_piece="first part.")
