...
from alvio.chat.stream_processing.citation_processing import CitationProcessor
...
"""
This module contains tests for the citation extraction functionality in Alvio,
...
def process_text(
    ...
    result: list[AlvioAnswerPiece | CitationInfo] = []
    for token in tokens:
    ...
    citations = []
    for piece in result:
        if isinstance(piece, AlvioAnswerPiece):
