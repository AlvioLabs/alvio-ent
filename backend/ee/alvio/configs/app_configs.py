...
SAML_CONF_DIR = os.environ.get("SAML_CONF_DIR") or "/app/ee/alvio/configs/saml_config"
...
# when the capture is called. These defaults prevent Posthog issues from breaking the Alvio app
