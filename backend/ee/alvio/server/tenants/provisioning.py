...
from ee.alvio.configs.app_configs import ANTHROPIC_DEFAULT_API_KEY
from ee.alvio.configs.app_configs import COHERE_DEFAULT_API_KEY
from ee.alvio.configs.app_configs import HUBSPOT_TRACKING_URL
from ee.alvio.configs.app_configs import OPENAI_DEFAULT_API_KEY
from ee.alvio.server.tenants.access import generate_data_plane_token
from ee.alvio.server.tenants.models import TenantByDomainResponse
from ee.alvio.server.tenants.models import TenantCreationPayload
from ee.alvio.server.tenants.models import TenantDeletionPayload
from ee.alvio.server.tenants.schema_management import create_schema_if_not_exists
from ee.alvio.server.tenants.schema_management import drop_schema
from ee.alvio.server.tenants.schema_management import run_alembic_migrations
from ee.alvio.server.tenants.user_mapping import add_users_to_tenant
from ee.alvio.server.tenants.user_mapping import get_tenant_id_for_email
from ee.alvio.server.tenants.user_mapping import user_owns_a_tenant
from alvio.auth.users import exceptions
from alvio.configs.app_configs import CONTROL_PLANE_API_BASE_URL
...
from alvio.db.llm import upsert_cloud_embedding_provider
from alvio.db.llm import upsert_llm_provider
from alvio.db.models import AvailableTenant
from alvio.db.models import IndexModelStatus
from alvio.db.models import SearchSettings
from alvio.db.models import UserTenantMapping
from alvio.llm.llm_provider_options import ANTHROPIC_MODEL_NAMES
from alvio.llm.llm_provider_options import ANTHROPIC_PROVIDER_NAME
from alvio.llm.llm_provider_options import ANTHROPIC_VISIBLE_MODEL_NAMES
from alvio.llm.llm_provider_options import OPEN_AI_MODEL_NAMES
from alvio.llm.llm_provider_options import OPEN_AI_VISIBLE_MODEL_NAMES
from alvio.llm.llm_provider_options import OPENAI_PROVIDER_NAME
from alvio.server.manage.embedding.models import CloudEmbeddingProviderCreationRequest
        ...
        try:
            ...
            if current_search_settings:
                ...
                current_search_settings.index_name = (
                    "alvio_chunk_cohere_embed_english_v3_0"
                )
...
async def setup_tenant(tenant_id: str) -> None:
    ...
    try:
        ...
        with get_session_with_tenant(tenant_id=tenant_id) as db_session:
            ...
            # Set up Alvio with appropriate settings
            ...
            setup_alvio(db_session, tenant_id, cohere_enabled=cohere_enabled)
