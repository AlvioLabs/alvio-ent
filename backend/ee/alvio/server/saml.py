...
from ee.alvio.configs.app_configs import SAML_CONF_DIR
from ee.alvio.db.saml import expire_saml_account
from ee.alvio.db.saml import get_saml_account
from ee.alvio.db.saml import upsert_saml_account
from ee.alvio.utils.secrets import encrypt_string
from ee.alvio.utils.secrets import extract_hashed_cookie
...
async def saml_login_callback(
    ...
    # Redirect to main Alvio search page
