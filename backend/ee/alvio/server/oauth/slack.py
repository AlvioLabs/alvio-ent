...
from alvio.configs.app_configs import OAUTH_SLACK_CLIENT_ID
from alvio.configs.app_configs import OAUTH_SLACK_CLIENT_SECRET
...
class SlackOAuth:
    # https://knock.io/blog/how-to-authenticate-users-in-slack-using-oauth
    ...
    # SCOPE is per https://docs.alvio.dev/connectors/slack
    BOT_SCOPE = (
        "channels:history,"
        "channels:read,"
        "groups:history,"
