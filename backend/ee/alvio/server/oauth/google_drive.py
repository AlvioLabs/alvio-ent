...
from ee.alvio.server.oauth.api_router import router
from alvio.auth.users import current_admin_user
from alvio.configs.app_configs import DEV_MODE
from alvio.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_ID
from alvio.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_SECRET
from alvio.configs.app_configs import WEB_DOMAIN
from alvio.configs.constants import DocumentSource
from alvio.connectors.google_utils.google_auth import get_google_oauth_creds
from alvio.connectors.google_utils.google_auth import sanitize_oauth_credentials
...
class GoogleDriveOAuth:
    ...
    # SCOPE is per https://docs.alvio.dev/connectors/google-drive
