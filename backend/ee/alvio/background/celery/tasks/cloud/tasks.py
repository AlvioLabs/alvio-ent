...
from ee.alvio.server.tenants.product_gating import get_gated_tenants
...
@shared_task(
    name=AlvioCeleryTask.CLOUD_BEAT_TASK_GENERATOR,
    ignore_result=True,
    trail=False,
    bind=True,
)
def cloud_beat_task_generator(
    self: Task,
    task_name: str,
    queue: str = AlvioCeleryTask.DEFAULT,
    priority: int = AlvioCeleryPriority.MEDIUM,
    ...
    lock_beat: RedisLock = redis_client.lock(
        f"{AlvioRedisLocks.CLOUD_BEAT_TASK_GENERATOR_LOCK}:{task_name}",
