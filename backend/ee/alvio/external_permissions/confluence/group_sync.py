...
from ee.alvio.external_permissions.confluence.constants import ALL_CONF_EMAILS_GROUP_NAME
from alvio.background.error_logging import emit_background_error
from alvio.connectors.confluence.alvio_confluence import (
...
def _build_group_member_email_map(
    confluence_client: AlvioConfluence, cc_pair_id: int
) -> dict[str, set[str]]:
...
def confluence_group_sync(
    ...
    provider = AlvioDBCredentialsProvider(tenant_id, "confluence", cc_pair.credential_id)
    ...
    confluence_client = AlvioConfluence(is_cloud, url, provider)
