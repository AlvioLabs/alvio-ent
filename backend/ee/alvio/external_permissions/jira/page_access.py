...
from ee.alvio.external_permissions.jira.models import Holder
from ee.alvio.external_permissions.jira.models import Permission
from ee.alvio.external_permissions.jira.models import User
