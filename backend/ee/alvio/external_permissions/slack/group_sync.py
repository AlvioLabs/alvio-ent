...
from ee.alvio.external_permissions.slack.utils import fetch_user_id_to_email_map
...
def slack_group_sync(
    ...
    provider = AlvioDBCredentialsProvider(tenant_id, "slack", cc_pair.credential.id)
