...
from alvio.agents.agent_search.dr.models import GeneratedImage
...
from alvio.file_store.utils import save_files
from alvio.server.query_and_chat.streaming_models import ImageGenerationToolHeartbeat
