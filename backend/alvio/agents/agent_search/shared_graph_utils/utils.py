...
from alvio.agents.agent_search.shared_graph_utils.models import BaseMessage_Content
from alvio.agents.agent_search.shared_graph_utils.models import (
    EntityRelationshipTermExtraction,
)
from alvio.agents.agent_search.shared_graph_utils.models import PersonaPromptExpressions
from alvio.agents.agent_search.shared_graph_utils.models import (
    StructuredSubquestionDocuments,
)
from alvio.agents.agent_search.shared_graph_utils.models import SubQuestionAnswerResults
from alvio.agents.agent_search.shared_graph_utils.operators import (
...
from alvio.chat.models import StreamStopInfo
from alvio.chat.models import StreamStopReason
from alvio.chat.models import StreamType
from alvio.configs.agent_configs import AGENT_MAX_TOKENS_HISTORY_SUMMARY
from alvio.configs.agent_configs import (
    AGENT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION,
)
from alvio.configs.agent_configs import AGENT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION
from alvio.configs.constants import DISPATCH_SEP_CHAR
from alvio.configs.constants import FORMAT_DOCS_SEPARATOR
...
from alvio.prompts.prompt_utils import handle_alvio_date_awareness
from alvio.server.query_and_chat.streaming_models import Packet
from alvio.server.query_and_chat.streaming_models import PacketObj
from alvio.tools.models import SearchToolOverrideKwargs
from alvio.tools.tool_implementations.search.search_tool import (
    SEARCH_RESPONSE_SUMMARY_ID,
)
from alvio.tools.tool_implementations.search.search_tool import SearchResponseSummary
...
def get_persona_agent_prompt_expressions(
    ...
    datetime_aware_system_prompt = handle_alvio_date_awareness(
