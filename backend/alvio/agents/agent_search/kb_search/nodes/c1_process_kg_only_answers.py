...
from alvio.agents.agent_search.kb_search.states import ResultsDataUpdate
from alvio.agents.agent_search.shared_graph_utils.utils import (
    get_langgraph_node_log_string,
)
from alvio.db.document import get_base_llm_doc_information
...
def _get_formated_source_reference_results(
    ...
    # get all entities that correspond to an Alvio document
