...
from alvio.configs.app_configs import AWS_REGION_NAME
from alvio.configs.app_configs import S3_AWS_ACCESS_KEY_ID
from alvio.configs.app_configs import S3_AWS_SECRET_ACCESS_KEY
from alvio.configs.app_configs import S3_ENDPOINT_URL
from alvio.configs.app_configs import S3_FILE_STORE_BUCKET_NAME
from alvio.configs.app_configs import S3_FILE_STORE_PREFIX
from alvio.configs.app_configs import S3_VERIFY_SSL
from alvio.configs.constants import FileOrigin
from alvio.db.engine.sql_engine import get_session_with_current_tenant
from alvio.db.engine.sql_engine import get_session_with_current_tenant_if_none
from alvio.db.file_record import delete_filerecord_by_file_id
from alvio.db.file_record import get_filerecord_by_file_id
from alvio.db.file_record import get_filerecord_by_file_id_optional
from alvio.db.file_record import get_filerecord_by_prefix
from alvio.db.file_record import upsert_filerecord
from alvio.db.models import FileRecord
from alvio.db.models import FileRecord as FileStoreModel
from alvio.file_store.s3_key_utils import generate_s3_key
...
class S3BackedFileStore(FileStore):
    ...
    def __init__(
        ...
        self._s3_prefix = s3_prefix or "alvio-files"
...
def get_default_file_store() -> FileStore:
    ...
    - S3_FILE_STORE_PREFIX=<prefix> (optional, defaults to 'alvio-files')
