...
from alvio.configs.constants import KV_CUSTOMER_UUID_KEY
from alvio.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
_ALVIO_TELEMETRY_ENDPOINT = "https://telemetry.alvio.io/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of Alvio
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for Alvio MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of Alvio.
    fetch_versioned_implementation_with_fallback(
        module="alvio.utils.telemetry",
