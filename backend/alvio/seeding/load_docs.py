...
from alvio.access.models import default_public_access
from alvio.configs.constants import DEFAULT_BOOST
from alvio.configs.constants import DocumentSource
from alvio.configs.constants import KV_DOCUMENTS_SEEDED_KEY
from alvio.configs.constants import RETURN_SEPARATOR
from alvio.configs.model_configs import DEFAULT_DOCUMENT_ENCODER_MODEL
...
from alvio.db.credentials import PUBLIC_CREDENTIAL_ID
from alvio.db.document import check_docs_exist
from alvio.db.document import mark_document_as_indexed_for_cc_pair__no_commit
from alvio.db.enums import AccessType
from alvio.db.enums import ConnectorCredentialPairStatus
from alvio.db.index_attempt import mock_successful_index_attempt
...
from alvio.indexing.indexing_pipeline import index_doc_batch_prepare
from alvio.indexing.models import ChunkEmbedding
...
def seed_initial_documents(
    ...
    connector_data = ConnectorBase(
        name="Alvio Docs Overview",
        source=DocumentSource.WEB,
        input_type=InputType.LOAD_STATE,
        connector_specific_config={
            "base_url": "https://docs.alvio.io/",
