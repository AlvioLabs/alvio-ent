...
from alvio.chat.prune_and_merge import _merge_sections
from alvio.chat.prune_and_merge import ChunkRange
from alvio.chat.prune_and_merge import merge_chunk_intervals
from alvio.chat.prune_and_merge import prune_and_merge_sections
from alvio.configs.chat_configs import DISABLE_LLM_DOC_RELEVANCE
from alvio.context.search.enums import LLMEvaluationType
from alvio.context.search.enums import QueryFlow
from alvio.context.search.enums import SearchType
from alvio.context.search.models import IndexFilters
from alvio.context.search.models import InferenceChunk
from alvio.context.search.models import InferenceSection
from alvio.context.search.models import RerankMetricsContainer
from alvio.context.search.models import RetrievalMetricsContainer
from alvio.context.search.models import SearchQuery
from alvio.context.search.models import SearchRequest
from alvio.context.search.postprocessing.postprocessing import cleanup_chunks
from alvio.context.search.postprocessing.postprocessing import search_postprocessing
from alvio.context.search.preprocessing.preprocessing import retrieval_preprocessing
from alvio.context.search.retrieval.search_runner import (
    retrieve_chunks,
)
from alvio.context.search.utils import inference_section_from_chunks
from alvio.context.search.utils import relevant_sections_to_indices
...
from alvio.secondary_llm_flows.agentic_evaluation import evaluate_inference_section
from alvio.utils.logger import setup_logger
from alvio.utils.threadpool_concurrency import FunctionCall
from alvio.utils.threadpool_concurrency import run_functions_in_parallel
...
class SearchPipeline:
    ...
    def _get_sections(self) -> list[InferenceSection]:
        ...
        censored_chunks: list[InferenceChunk] = fetch_ee_implementation_or_noop(
            "alvio.external_permissions.post_query_censoring",
