...
from alvio.configs.constants import POSTGRES_CELERY_WORKER_DOCFETCHING_APP_NAME
...
celery_app.config_from_object("alvio.background.celery.configs.docfetching")
...
celery_app.autodiscover_tasks(
    [
        "alvio.background.celery.tasks.docfetching",
    ]
)
