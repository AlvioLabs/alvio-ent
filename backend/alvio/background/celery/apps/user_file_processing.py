...
from alvio.configs.constants import POSTGRES_CELERY_WORKER_USER_FILE_PROCESSING_APP_NAME
...
celery_app.config_from_object("alvio.background.celery.configs.user_file_processing")
...
celery_app.autodiscover_tasks(
    [
        "alvio.background.celery.tasks.user_file_processing",
    ]
)
