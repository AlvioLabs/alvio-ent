...
from alvio.configs.constants import POSTGRES_CELERY_BEAT_APP_NAME
...
celery_app.config_from_object("alvio.background.celery.configs.beat")
...
class DynamicTenantScheduler(PersistentScheduler):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._last_reload = self.io.now() - self._reload_interval
    ...
    def _generate_schedule(
        ...
        if MULTI_TENANT:
            ...
            get_cloud_tasks_to_schedule = fetch_versioned_implementation(
                "alvio.background.celery.tasks.beat_schedule",
        ...
        get_tasks_to_schedule = fetch_versioned_implementation(
            "alvio.background.celery.tasks.beat_schedule", "get_tasks_to_schedule"
        )
