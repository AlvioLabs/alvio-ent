...
from alvio.configs.constants import POSTGRES_CELERY_WORKER_MONITORING_APP_NAME
...
celery_app.config_from_object("alvio.background.celery.configs.monitoring")
...
celery_app.autodiscover_tasks(
    [
        "alvio.background.celery.tasks.monitoring",
    ]
)
