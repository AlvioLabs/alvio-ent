...
from alvio.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from alvio.configs.app_configs import CELERY_RESULT_EXPIRES
from alvio.configs.app_configs import REDIS_DB_NUMBER_CELERY
from alvio.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
...
broker_transport_options = {
    "priority_steps": list(range(len(AlvioCeleryPriority))),
...
task_default_priority = AlvioCeleryPriority.MEDIUM
task_acks_late = True
