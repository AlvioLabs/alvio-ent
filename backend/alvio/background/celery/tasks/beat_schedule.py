...
from alvio.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from alvio.configs.app_configs import LLM_MODEL_UPDATE_API_URL
from alvio.configs.constants import ALVIO_CLOUD_CELERY_TASK_PREFIX
...
beat_task_templates: list[dict] = [
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_USER_FILE_PROCESSING,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.USER_FILE_DOCID_MIGRATION,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_KG_PROCESSING,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_KG_PROCESSING_CLUSTERING_ONLY,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_INDEXING,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_CHECKPOINT_CLEANUP,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_INDEX_ATTEMPT_CLEANUP,
        "schedule": timedelta(hours=1),
        "options": {
            "priority": AlvioCeleryPriority.LOW,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": AlvioCeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": AlvioCeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.CHECK_FOR_PRUNING,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": AlvioCeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": AlvioCeleryTask.MONITOR_BACKGROUND_PROCESSES,
        ...
        [
            {
                ...
                "task": AlvioCeleryTask.CHECK_FOR_DOC_PERMISSIONS_SYNC,
            ...
            },
            {
                ...
                "task": AlvioCeleryTask.CHECK_FOR_EXTERNAL_GROUP_SYNC,
                "schedule": timedelta(seconds=20),
                "options": {
                    "priority": AlvioCeleryPriority.MEDIUM,
                    "expires": BEAT_EXPIRES_DEFAULT,
    ...
    beat_task_templates.append(
        {
            ...
            "task": AlvioCeleryTask.CHECK_FOR_LLM_MODEL_UPDATE,
...
def make_cloud_generator_task(task: dict[str, Any]) -> dict[str, Any]:
    ...
    cloud_task["options"] = {}
    cloud_task["options"]["priority"] = AlvioCeleryPriority.HIGHEST
    cloud_task["options"]["expires"] = BEAT_EXPIRES_DEFAULT

    # settings dependent on the original task
    cloud_task["name"] = f"{ALVIO_CLOUD_CELERY_TASK_PREFIX}_{task['name']}"
    cloud_task["task"] = AlvioCeleryTask.CLOUD_BEAT_TASK_GENERATOR
    cloud_task["kwargs"] = {}
...
# the name attribute must start with ALVIO_CLOUD_CELERY_TASK_PREFIX = "cloud" to be seen
# by the DynamicTenantScheduler as system wide task and not a per tenant task
beat_cloud_tasks: list[dict] = [
    # cloud specific tasks
    {
        "name": f"{ALVIO_CLOUD_CELERY_TASK_PREFIX}_monitor-alembic",
        "task": AlvioCeleryTask.CLOUD_MONITOR_ALEMBIC,
        "schedule": timedelta(hours=1),
        "options": {
            "queue": AlvioCeleryQueues.MONITORING,
    ...
    {
        "name": f"{ALVIO_CLOUD_CELERY_TASK_PREFIX}_monitor-celery-queues",
        "task": AlvioCeleryTask.CLOUD_MONITOR_CELERY_QUEUES,
        "schedule": timedelta(seconds=30),
        "options": {
            "queue": AlvioCeleryQueues.MONITORING,
            "priority": AlvioCeleryPriority.HIGH,
    ...
    {
        "name": f"{ALVIO_CLOUD_CELERY_TASK_PREFIX}_check-available-tenants",
        "task": AlvioCeleryTask.CLOUD_CHECK_AVAILABLE_TENANTS,
    ...
    {
        "name": f"{ALVIO_CLOUD_CELERY_TASK_PREFIX}_monitor-celery-pidbox",
        "task": AlvioCeleryTask.CLOUD_MONITOR_CELERY_PIDBOX,
        ...
        [
            {
                ...
                "task": AlvioCeleryTask.MONITOR_CELERY_QUEUES,
            ...
            },
            {
                ...
                "task": AlvioCeleryTask.MONITOR_PROCESS_MEMORY,
                "schedule": timedelta(minutes=5),
                "options": {
                    "priority": AlvioCeleryPriority.LOW,
                    "expires": BEAT_EXPIRES_DEFAULT,
            ...
            },
            {
                ...
                "task": AlvioCeleryTask.CELERY_BEAT_HEARTBEAT,
                "schedule": timedelta(minutes=1),
                "options": {
                    "priority": AlvioCeleryPriority.HIGHEST,
                    "expires": BEAT_EXPIRES_DEFAULT,
                    "queue": AlvioCeleryQueues.PRIMARY,
                },
            },
        ]
    )
