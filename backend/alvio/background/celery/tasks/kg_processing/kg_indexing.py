...
from alvio.background.celery.apps.client import celery_app
from alvio.background.celery.tasks.kg_processing.utils import is_kg_processing_blocked
...
def try_creating_kg_source_reset_task(
    ...
    try:
        ...
        result = celery_app.send_task(
            AlvioCeleryTask.KG_RESET_SOURCE_INDEX,
            kwargs=dict(
                tenant_id=tenant_id,
