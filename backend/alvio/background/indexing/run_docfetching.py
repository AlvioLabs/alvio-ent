...
from alvio.access.access import source_should_fetch_permissions_during_indexing
from alvio.background.indexing.checkpointing_utils import check_checkpoint_size
from alvio.background.indexing.checkpointing_utils import get_latest_valid_checkpoint
from alvio.background.indexing.checkpointing_utils import save_checkpoint
from alvio.background.indexing.memory_tracer import MemoryTracer
from alvio.configs.app_configs import INDEX_BATCH_SIZE
from alvio.configs.app_configs import INDEXING_SIZE_WARNING_THRESHOLD
from alvio.configs.app_configs import INDEXING_TRACER_INTERVAL
from alvio.configs.app_configs import INTEGRATION_TESTS_MODE
from alvio.configs.app_configs import LEAVE_CONNECTOR_ACTIVE_ON_INITIALIZATION_FAILURE
from alvio.configs.app_configs import MAX_FILE_SIZE_BYTES
from alvio.configs.app_configs import POLL_CONNECTOR_OFFSET
...
from alvio.connectors.connector_runner import ConnectorRunner
from alvio.connectors.exceptions import ConnectorValidationError
from alvio.connectors.exceptions import UnexpectedValidationError
from alvio.connectors.interfaces import CheckpointedConnector
from alvio.connectors.models import ConnectorFailure
from alvio.connectors.models import ConnectorStopSignal
from alvio.connectors.models import DocExtractionContext
...
from alvio.db.connector import mark_cc_pair_as_permissions_synced
...
from alvio.db.connector_credential_pair import get_last_successful_attempt_poll_range_end
from alvio.db.connector_credential_pair import update_connector_credential_pair
from alvio.db.constants import CONNECTOR_VALIDATION_ERROR_MESSAGE_PREFIX
...
from alvio.db.enums import IndexModelStatus
...
from alvio.db.index_attempt import get_recent_completed_attempts_for_cc_pair
...
from alvio.db.index_attempt import transition_attempt_to_in_progress
from alvio.db.index_attempt import update_docs_indexed
from alvio.db.indexing_coordination import IndexingCoordination
from alvio.db.models import IndexAttempt
from alvio.db.models import IndexAttemptError
...
def _get_connector_runner(
    ...
    """
    from alvio.connectors.factory import instantiate_connector
    ...
    try:
        ...
        while checkpoint.has_more:
            ...
            for document_batch, failure, next_checkpoint in connector_runner.run(
                ...
                index_attempt_md.request_id = make_randomized_alvio_request_id("CIX")
    ...
    try:
        ...
        while checkpoint.has_more:
            ...
            for document_batch, failure, next_checkpoint in connector_runner.run(
                ...
                app.send_task(
                    AlvioCeleryTask.DOCPROCESSING_TASK,
                    kwargs=processing_batch_data,
                    queue=AlvioCeleryQueues.DOCPROCESSING,
