...
from alvio.configs.app_configs import VESPA_NUM_ATTEMPTS_ON_STARTUP
from alvio.configs.chat_configs import INPUT_PROMPT_YAML
from alvio.configs.constants import KV_REINDEX_KEY
from alvio.configs.constants import KV_SEARCH_SETTINGS
from alvio.configs.embedding_configs import SUPPORTED_EMBEDDING_MODELS
from alvio.configs.embedding_configs import SupportedEmbeddingModel
from alvio.configs.model_configs import FAST_GEN_AI_MODEL_VERSION
from alvio.configs.model_configs import GEN_AI_API_KEY
from alvio.configs.model_configs import GEN_AI_MODEL_VERSION
from alvio.context.search.models import SavedSearchSettings
from alvio.context.search.retrieval.search_runner import (
    download_nltk_data,
)
from alvio.db.connector import check_connectors_exist
from alvio.db.connector import create_initial_default_connector
from alvio.db.connector_credential_pair import associate_default_cc_pair
from alvio.db.connector_credential_pair import get_connector_credential_pairs
from alvio.db.connector_credential_pair import resync_cc_pair
from alvio.db.credentials import create_initial_public_credential
from alvio.db.document import check_docs_exist
from alvio.db.enums import EmbeddingPrecision
from alvio.db.index_attempt import cancel_indexing_attempts_past_model
from alvio.db.index_attempt import expire_index_attempts
from alvio.db.llm import fetch_default_provider
from alvio.db.llm import update_default_provider
from alvio.db.llm import upsert_llm_provider
...
from alvio.db.search_settings import update_current_search_settings
from alvio.db.search_settings import update_secondary_search_settings
...
from alvio.llm.llm_provider_options import OPEN_AI_MODEL_NAMES
...
from alvio.natural_language_processing.search_nlp_models import warm_up_cross_encoder
from alvio.seeding.load_docs import seed_initial_documents
from alvio.seeding.load_yamls import load_input_prompts_from_yaml
from alvio.server.manage.llm.models import LLMProviderUpsertRequest
from alvio.server.manage.llm.models import ModelConfigurationUpsertRequest
from alvio.server.settings.store import load_settings
from alvio.server.settings.store import store_settings
from alvio.utils.gpu_utils import gpu_status_request
...
def setup_alvio(
    ...
    """
    Setup Alvio for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_alvio() -> None:
