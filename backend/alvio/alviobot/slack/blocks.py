...
from alvio.configs.alviobot_configs import ALVIO_BOT_NUM_DOCS_TO_DISPLAY
from alvio.context.search.models import SavedSearchDoc
from alvio.db.chat import get_chat_session_by_message_id
from alvio.db.engine.sql_engine import get_session_with_current_tenant
from alvio.db.models import ChannelConfig
from alvio.alviobot.slack.constants import CONTINUE_IN_WEB_UI_ACTION_ID
...
from alvio.alviobot.slack.formatting import format_slack_message
from alvio.alviobot.slack.icons import source_to_github_img_link
from alvio.alviobot.slack.models import ActionValuesEphemeralMessage
from alvio.alviobot.slack.models import ActionValuesEphemeralMessageChannelConfig
from alvio.alviobot.slack.models import ActionValuesEphemeralMessageMessageInfo
from alvio.alviobot.slack.models import SlackMessageInfo
from alvio.alviobot.slack.utils import build_continue_in_web_ui_id
from alvio.alviobot.slack.utils import build_feedback_id
from alvio.alviobot.slack.utils import build_publish_ephemeral_message_id
from alvio.alviobot.slack.utils import remove_slack_text_interactions
from alvio.alviobot.slack.utils import translate_vespa_highlight_to_slack
from alvio.utils.text_processing import decode_escapes
...
def _build_documents_blocks(
    ...
    message_id: int | None,
    num_docs_to_display: int = ALVIO_BOT_NUM_DOCS_TO_DISPLAY,
) -> list[Block]:
    header_text = (
...
def build_slack_response_blocks(
    ...
    """
    # If called with the AlvioBot slash command, the question is lost so we have to reshow it
