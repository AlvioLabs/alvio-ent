...
from alvio.configs.app_configs import LITELLM_CUSTOM_ERROR_MESSAGE_MAPPINGS
...
from alvio.configs.model_configs import GEN_AI_MAX_TOKENS
from alvio.configs.model_configs import GEN_AI_MODEL_FALLBACK_MAX_TOKENS
from alvio.configs.model_configs import GEN_AI_NUM_RESERVED_OUTPUT_TOKENS
...
from alvio.prompts.chat_prompts import CONTEXTUAL_RAG_TOKEN_ESTIMATE
from alvio.prompts.chat_prompts import DOCUMENT_SUMMARY_TOKEN_ESTIMATE
from alvio.prompts.constants import CODE_BLOCK_PAT
...
def get_max_input_tokens(
    ...
    # https://litellm.vercel.io/docs/completion/token_usage#7-model_cost
