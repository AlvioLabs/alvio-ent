...
from alvio.configs.app_configs import LOG_ALVIO_MODEL_INTERACTIONS
from alvio.configs.app_configs import MOCK_LLM_RESPONSE
from alvio.configs.chat_configs import QA_TIMEOUT
from alvio.configs.model_configs import (
    DISABLE_LITELLM_STREAMING,
)
from alvio.configs.model_configs import GEN_AI_TEMPERATURE
from alvio.configs.model_configs import LITELLM_EXTRA_BODY
from alvio.llm.interfaces import LLM
from alvio.llm.interfaces import LLMConfig
from alvio.llm.interfaces import ToolChoiceOptions
from alvio.llm.utils import model_is_reasoning_model
from alvio.server.utils import mask_string
...
class DefaultMultiLLM(LLM):
    ...
    def _invoke_implementation(
        ...
        if LOG_ALVIO_MODEL_INTERACTIONS:
    ...
    def _stream_implementation(
        ...
        if LOG_ALVIO_MODEL_INTERACTIONS and output:
