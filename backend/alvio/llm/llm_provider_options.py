...
from alvio.llm.chat_llm import VERTEX_CREDENTIALS_FILE_KWARG
from alvio.llm.chat_llm import VERTEX_LOCATION_KWARG
from alvio.llm.utils import model_supports_image_input
from alvio.server.manage.llm.models import ModelConfigurationView
        ...
        WellKnownLLMProviderDescriptor(
            ...
            custom_config_keys=[
                ...
                CustomConfigKey(
                    ...
                    "[Vertex AI configuration docs](https://docs.alvio.io/admin/ai_models/google_ai) for all possible values.",
                    is_required=False,
                    is_secret=False,
