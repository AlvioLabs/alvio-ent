...
from alvio.configs.chat_configs import DOC_TIME_DECAY
from alvio.configs.chat_configs import NUM_RETURNED_HITS
from alvio.configs.chat_configs import TITLE_CONTENT_RATIO
from alvio.configs.chat_configs import VESPA_SEARCHER_THREADS
from alvio.configs.constants import KV_REINDEX_KEY
from alvio.context.search.models import IndexFilters
from alvio.context.search.models import InferenceChunkUncleaned
from alvio.db.enums import EmbeddingPrecision
from alvio.document_index.document_index_utils import get_document_chunk_ids
from alvio.document_index.document_index_utils import get_uuid_from_chunk_info
from alvio.document_index.interfaces import DocumentIndex
from alvio.document_index.interfaces import DocumentInsertionRecord
from alvio.document_index.interfaces import EnrichedDocumentIndexingInfo
from alvio.document_index.interfaces import IndexBatchParams
from alvio.document_index.interfaces import MinimalDocumentIndexingInfo
from alvio.document_index.interfaces import UpdateRequest
from alvio.document_index.interfaces import VespaChunkRequest
from alvio.document_index.interfaces import VespaDocumentFields
from alvio.document_index.interfaces import VespaDocumentUserFields
from alvio.document_index.vespa.chunk_retrieval import batch_search_api_retrieval
from alvio.document_index.vespa.chunk_retrieval import (
    parallel_visit_api_retrieval,
)
from alvio.document_index.vespa.chunk_retrieval import query_vespa
from alvio.document_index.vespa.deletion import delete_vespa_chunks
from alvio.document_index.vespa.indexing_utils import BaseHTTPXClientContext
from alvio.document_index.vespa.indexing_utils import batch_index_vespa_chunks
from alvio.document_index.vespa.indexing_utils import check_for_final_chunk_existence
from alvio.document_index.vespa.indexing_utils import clean_chunk_id_copy
from alvio.document_index.vespa.indexing_utils import GlobalHTTPXClientContext
from alvio.document_index.vespa.indexing_utils import TemporaryHTTPXClientContext
from alvio.document_index.vespa.shared_utils.utils import get_vespa_http_client
from alvio.document_index.vespa.shared_utils.utils import (
    replace_invalid_doc_id_characters,
)
from alvio.document_index.vespa.shared_utils.vespa_request_builders import (
    build_vespa_filters,
)
from alvio.document_index.vespa_constants import ACCESS_CONTROL_LIST
from alvio.document_index.vespa_constants import BATCH_SIZE
from alvio.document_index.vespa_constants import BOOST
from alvio.document_index.vespa_constants import CONTENT_SUMMARY
from alvio.document_index.vespa_constants import DOCUMENT_ID_ENDPOINT
from alvio.document_index.vespa_constants import DOCUMENT_SETS
from alvio.document_index.vespa_constants import HIDDEN
from alvio.document_index.vespa_constants import NUM_THREADS
from alvio.document_index.vespa_constants import USER_PROJECT
from alvio.document_index.vespa_constants import VESPA_APPLICATION_ENDPOINT
from alvio.document_index.vespa_constants import VESPA_TIMEOUT
from alvio.document_index.vespa_constants import YQL_BASE
from alvio.indexing.models import DocMetadataAwareIndexChunk
from alvio.key_value_store.factory import get_shared_kv_store
from alvio.kg.utils.formatting_utils import split_relationship_id
from alvio.utils.batching import batch_generator
...
class VespaIndex(DocumentIndex):
    ...
    VESPA_SCHEMA_JINJA_FILENAME = "alvio_chunk.sd.jinja"
    ...
    def ensure_indices_exist(
        ...
        vespa_schema_path = os.path.join(
            os.getcwd(), "alvio", "document_index", "vespa", "app_config"
        )
        ...
        if response.status_code != 200:
            logger.error(
                f"Failed to prepare Vespa Alvio Index. Response: {response.text}"
            )
            raise RuntimeError(
                f"Failed to prepare Vespa Alvio Index. Response: {response.text}"
            )
    ...
    def register_multitenant_indices(
        ...
        if response.status_code != 200:
            raise RuntimeError(
                f"Failed to prepare Vespa Alvio Indexes. Response: {response.text}"
            )
