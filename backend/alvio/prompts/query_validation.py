...
from alvio.prompts.constants import QUESTION_PAT
...
{QUESTION_PAT.upper()} Alvio is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to Alvio being unreachable. \
Assuming the documents from search contains situations where Alvio is not reachable and \
