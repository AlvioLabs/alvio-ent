...
from alvio.db.constants import SLACK_BOT_PERSONA_PREFIX
...
from alvio.db.slack_bot import insert_slack_bot
from alvio.db.slack_bot import remove_slack_bot
from alvio.db.slack_bot import update_slack_bot
from alvio.db.slack_channel_config import create_slack_channel_persona
from alvio.db.slack_channel_config import fetch_slack_channel_config
from alvio.db.slack_channel_config import fetch_slack_channel_configs
from alvio.db.slack_channel_config import insert_slack_channel_config
from alvio.db.slack_channel_config import remove_slack_channel_config
from alvio.db.slack_channel_config import update_slack_channel_config
from alvio.alviobot.slack.config import validate_channel_name
from alvio.server.manage.models import SlackBot
from alvio.server.manage.models import SlackBotCreationRequest
from alvio.server.manage.models import SlackChannelConfig
from alvio.server.manage.models import SlackChannelConfigCreationRequest
from alvio.server.manage.validate_tokens import validate_app_token
from alvio.server.manage.validate_tokens import validate_bot_token
from alvio.server.manage.validate_tokens import validate_user_token
...
def _form_channel_config(
    ...
    if respond_tag_only and respond_member_group_list:
        raise ValueError(
            "Cannot set AlvioBot to only respond to tags only and "
    ...
    if (
        ...
        raise ValueError(
            "Cannot set AlvioBot to respond to users in a private (ephemeral) message "
...
def create_bot(
    ...
    create_milestone_and_report(
        ...
        event_type=MilestoneRecordType.CREATED_ALVIO_BOT,
        properties=None,
        db_session=db_session,
    )
