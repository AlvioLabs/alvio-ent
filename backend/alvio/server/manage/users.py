...
from alvio.auth.email_utils import send_user_email_invite
from alvio.auth.invited_users import get_invited_users
from alvio.auth.invited_users import remove_user_from_invited_users
from alvio.auth.invited_users import write_invited_users
from alvio.auth.noauth_user import fetch_no_auth_user
from alvio.auth.noauth_user import set_no_auth_user_preferences
...
from alvio.auth.users import optional_user
from alvio.configs.app_configs import AUTH_BACKEND
from alvio.configs.app_configs import AUTH_TYPE
from alvio.configs.app_configs import AuthBackend
from alvio.configs.app_configs import DEV_MODE
from alvio.configs.app_configs import ENABLE_EMAIL_INVITES
from alvio.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from alvio.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from alvio.configs.app_configs import VALID_EMAIL_DOMAINS
from alvio.configs.constants import AuthType
from alvio.configs.constants import FASTAPI_USERS_AUTH_COOKIE_NAME
from alvio.db.api_key import is_api_key_email_address
from alvio.db.auth import get_live_users_count
from alvio.db.engine.sql_engine import get_session
from alvio.db.enums import UserFileStatus
from alvio.db.models import User
from alvio.db.models import UserFile
from alvio.db.user_preferences import activate_user
from alvio.db.user_preferences import deactivate_user
from alvio.db.user_preferences import get_all_user_assistant_specific_configs
from alvio.db.user_preferences import get_latest_access_token_for_user
from alvio.db.user_preferences import update_assistant_preferences
from alvio.db.user_preferences import update_user_assistant_visibility
from alvio.db.user_preferences import update_user_auto_scroll
from alvio.db.user_preferences import update_user_default_model
from alvio.db.user_preferences import update_user_pinned_assistants
from alvio.db.user_preferences import update_user_role
from alvio.db.user_preferences import update_user_shortcut_enabled
from alvio.db.user_preferences import update_user_temperature_override_enabled
from alvio.db.users import delete_user_from_db
from alvio.db.users import get_all_users
from alvio.db.users import get_page_of_filtered_users
from alvio.db.users import get_total_filtered_users_count
from alvio.db.users import get_user_by_email
from alvio.db.users import validate_user_role_update
from alvio.key_value_store.factory import get_kv_store
from alvio.redis.redis_pool import get_raw_redis_client
from alvio.server.documents.models import PaginatedReturn
from alvio.server.features.projects.models import UserFileSnapshot
from alvio.server.manage.models import AllUsersResponse
from alvio.server.manage.models import AutoScrollRequest
from alvio.server.manage.models import TenantInfo
from alvio.server.manage.models import TenantSnapshot
from alvio.server.manage.models import UserByEmail
from alvio.server.manage.models import UserInfo
from alvio.server.manage.models import UserPreferences
from alvio.server.manage.models import UserRoleResponse
from alvio.server.manage.models import UserRoleUpdateRequest
from alvio.server.manage.models import UserSpecificAssistantPreference
from alvio.server.manage.models import UserSpecificAssistantPreferences
from alvio.server.models import FullUserSnapshot
from alvio.server.models import InvitedUserSnapshot
from alvio.server.models import MinimalUserSnapshot
...
async def test_upsert_user(
    ...
    user = await fetch_ee_implementation_or_noop(
        "alvio.server.saml", "upsert_saml_user", None
    )(email=request.email)
...
def bulk_invite_users(
    ...
    if MULTI_TENANT:
        try:
            fetch_ee_implementation_or_noop(
                "alvio.server.tenants.provisioning", "add_users_to_tenant", None
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "alvio.server.tenants.billing", "register_tenant_users", None
        ...
        fetch_ee_implementation_or_noop(
            "alvio.server.tenants.user_mapping", "remove_users_from_tenant", None
        )(new_invited_emails, tenant_id)
        raise e
...
def verify_user_logged_in(
    ...
    team_name = fetch_ee_implementation_or_noop(
        "alvio.server.tenants.user_mapping", "get_tenant_id_for_email", None
    )(user.email)
    ...
    if MULTI_TENANT:
        if team_name != get_current_tenant_id():
            user_count = fetch_ee_implementation_or_noop(
                "alvio.server.tenants.user_mapping", "get_tenant_count", None
            )(team_name)
        ...
        tenant_invitation = fetch_ee_implementation_or_noop(
            "alvio.server.tenants.user_mapping", "get_tenant_invitation", None
        )(user.email)

    super_users_list = cast(
        list[str],
        fetch_versioned_implementation_with_fallback(
            "alvio.configs.app_configs",
            "SUPER_USERS",
            [],
        ),
    )
