...
from alvio.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from alvio.configs.constants import DocumentSource
from alvio.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
from alvio.configs.constants import AlvioCeleryPriority
from alvio.configs.constants import AlvioCeleryTask
from alvio.db.connector_credential_pair import get_connector_credential_pair_for_user
...
from alvio.db.feedback import fetch_docs_ranked_by_boost_for_user
from alvio.db.feedback import update_document_boost_for_user
from alvio.db.feedback import update_document_hidden_for_user
from alvio.db.index_attempt import cancel_indexing_attempts_for_ccpair
...
from alvio.server.manage.models import BoostDoc
from alvio.server.manage.models import BoostUpdateRequest
from alvio.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    client_app.send_task(
        AlvioCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
