...
from alvio.context.search.models import SearchSettingsCreationRequest
...
from alvio.db.search_settings import create_search_settings
from alvio.db.search_settings import delete_search_settings
from alvio.db.search_settings import get_current_search_settings
from alvio.db.search_settings import get_embedding_provider_from_provider_type
...
from alvio.db.search_settings import update_search_settings_status
...
from alvio.file_processing.unstructured import delete_unstructured_api_key
from alvio.file_processing.unstructured import get_unstructured_api_key
from alvio.file_processing.unstructured import update_unstructured_api_key
from alvio.natural_language_processing.search_nlp_models import clean_model_name
from alvio.server.manage.embedding.models import SearchSettingsDeleteRequest
from alvio.server.manage.models import FullModelVersionResponse
from alvio.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if search_settings_new.index_name is None:
        ...
        index_name = f"alvio_chunk_{clean_model_name(search_settings_new.model_name)}"
        if (
