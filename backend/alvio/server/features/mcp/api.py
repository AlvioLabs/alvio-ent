...
from alvio.db.enums import MCPAuthenticationPerformer
from alvio.db.enums import MCPAuthenticationType
from alvio.db.mcp import create_connection_config
from alvio.db.mcp import create_mcp_server__no_commit
from alvio.db.mcp import delete_connection_config
from alvio.db.mcp import delete_mcp_server
from alvio.db.mcp import delete_user_connection_configs_for_server
from alvio.db.mcp import get_all_mcp_servers
from alvio.db.mcp import get_mcp_server_auth_performer
from alvio.db.mcp import get_mcp_server_by_id
from alvio.db.mcp import get_mcp_servers_for_persona
from alvio.db.mcp import get_server_auth_template
from alvio.db.mcp import get_user_connection_config
from alvio.db.mcp import update_connection_config
from alvio.db.mcp import update_mcp_server__no_commit
from alvio.db.mcp import upsert_user_connection_config
from alvio.db.models import MCPConnectionConfig
from alvio.db.models import MCPServer as DbMCPServer
from alvio.db.models import User
from alvio.db.tools import create_tool__no_commit
from alvio.db.tools import delete_tool__no_commit
from alvio.db.tools import get_tools_by_mcp_server_id
from alvio.redis.redis_pool import get_redis_client
from alvio.server.documents.standard_oauth import _OAUTH_STATE_EXPIRATION_SECONDS
from alvio.server.documents.standard_oauth import _OAUTH_STATE_KEY_FMT
from alvio.server.features.mcp.models import MCPApiKeyResponse
from alvio.server.features.mcp.models import MCPAuthTemplate
from alvio.server.features.mcp.models import MCPConnectionData
from alvio.server.features.mcp.models import MCPDynamicClientRegistrationRequest
from alvio.server.features.mcp.models import MCPDynamicClientRegistrationResponse
from alvio.server.features.mcp.models import MCPOAuthCallbackResponse
from alvio.server.features.mcp.models import MCPServer
from alvio.server.features.mcp.models import MCPServerCreateResponse
from alvio.server.features.mcp.models import MCPServersResponse
from alvio.server.features.mcp.models import MCPServerUpdateResponse
from alvio.server.features.mcp.models import MCPToolCreateRequest
from alvio.server.features.mcp.models import MCPToolListResponse
from alvio.server.features.mcp.models import MCPToolUpdateRequest
from alvio.server.features.mcp.models import MCPUserCredentialsRequest
from alvio.server.features.mcp.models import MCPUserOAuthInitiateRequest
from alvio.server.features.mcp.models import MCPUserOAuthInitiateResponse
from alvio.tools.tool_implementations.mcp.mcp_client import discover_mcp_tools
    ...
    try:
        with httpx.Client(timeout=10.0) as client:
            ...
            registration_request = {
                ...
                "client_name": f"Alvio MCP Client for {mcp_server.name}",
