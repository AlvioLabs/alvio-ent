...
from alvio.db.document_set import check_document_sets_are_public
from alvio.db.document_set import fetch_all_document_sets_for_user
from alvio.db.document_set import get_document_set_by_id
from alvio.db.document_set import insert_document_set
from alvio.db.document_set import mark_document_set_as_to_be_deleted
from alvio.db.document_set import update_document_set
from alvio.db.engine.sql_engine import get_session
from alvio.db.models import User
from alvio.server.features.document_set.models import CheckDocSetPublicRequest
from alvio.server.features.document_set.models import CheckDocSetPublicResponse
from alvio.server.features.document_set.models import DocumentSetCreationRequest
from alvio.server.features.document_set.models import DocumentSetSummary
from alvio.server.features.document_set.models import DocumentSetUpdateRequest
...
def create_document_set(
    ...
    client_app.send_task(
        AlvioCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
