...
from alvio.chat.chat_utils import extract_headers
from alvio.chat.process_message import stream_chat_message
from alvio.chat.prompt_builder.citations_prompt import (
    compute_max_document_tokens_for_persona,
)
from alvio.configs.app_configs import WEB_DOMAIN
from alvio.configs.chat_configs import HARD_DELETE_CHATS
from alvio.configs.constants import MessageType
from alvio.configs.constants import MilestoneRecordType
from alvio.configs.model_configs import LITELLM_PASS_THROUGH_HEADERS
from alvio.db.chat import add_chats_to_session_from_slack_thread
from alvio.db.chat import create_chat_session
from alvio.db.chat import create_new_chat_message
from alvio.db.chat import delete_all_chat_sessions_for_user
from alvio.db.chat import delete_chat_session
from alvio.db.chat import duplicate_chat_session_for_user_from_slack
from alvio.db.chat import get_chat_message
from alvio.db.chat import get_chat_messages_by_session
from alvio.db.chat import get_chat_session_by_id
from alvio.db.chat import get_chat_sessions_by_user
from alvio.db.chat import get_or_create_root_message
from alvio.db.chat import set_as_latest_chat_message
from alvio.db.chat import translate_db_message_to_chat_message_detail
from alvio.db.chat import update_chat_session
from alvio.db.chat_search import search_chat_sessions
from alvio.db.engine.sql_engine import get_session
from alvio.db.engine.sql_engine import get_session_with_tenant
from alvio.db.feedback import create_chat_message_feedback
from alvio.db.feedback import create_doc_retrieval_feedback
from alvio.db.models import User
from alvio.db.persona import get_persona_by_id
from alvio.db.projects import check_project_ownership
from alvio.db.user_file import get_file_id_by_user_file_id
from alvio.file_processing.extract_file_text import docx_to_txt_filename
from alvio.file_store.file_store import get_default_file_store
from alvio.llm.exceptions import GenAIDisabledException
from alvio.llm.factory import get_default_llms
from alvio.llm.factory import get_llms_for_persona
from alvio.natural_language_processing.utils import get_tokenizer
from alvio.secondary_llm_flows.chat_session_naming import (
    get_renamed_conversation_name,
)
from alvio.server.query_and_chat.models import ChatFeedbackRequest
from alvio.server.query_and_chat.models import ChatMessageIdentifier
from alvio.server.query_and_chat.models import ChatRenameRequest
from alvio.server.query_and_chat.models import ChatSearchResponse
from alvio.server.query_and_chat.models import ChatSessionCreationRequest
from alvio.server.query_and_chat.models import ChatSessionDetailResponse
from alvio.server.query_and_chat.models import ChatSessionDetails
from alvio.server.query_and_chat.models import ChatSessionGroup
from alvio.server.query_and_chat.models import ChatSessionsResponse
from alvio.server.query_and_chat.models import ChatSessionSummary
from alvio.server.query_and_chat.models import ChatSessionUpdateRequest
from alvio.server.query_and_chat.models import CreateChatMessageRequest
from alvio.server.query_and_chat.models import CreateChatSessionID
from alvio.server.query_and_chat.models import LLMOverride
from alvio.server.query_and_chat.models import PromptOverride
from alvio.server.query_and_chat.models import RenameChatSessionResponse
from alvio.server.query_and_chat.models import SearchFeedbackRequest
from alvio.server.query_and_chat.models import UpdateChatSessionTemperatureRequest
from alvio.server.query_and_chat.models import UpdateChatSessionThreadRequest
...
from alvio.server.query_and_chat.streaming_utils import translate_db_message_to_packets
from alvio.server.query_and_chat.token_limit import check_token_rate_limits
from alvio.utils.headers import get_custom_tool_additional_request_headers
...
def get_chat_session(
    ...
    return ChatSessionDetailResponse(
        ...
        # specifically for the Alvio Chat UI
