...
from alvio.agents.agent_search.kb_search.models import KGEntityDocInfo
from alvio.configs.constants import DEFAULT_BOOST
from alvio.configs.constants import DocumentSource
from alvio.configs.kg_configs import KG_SIMPLE_ANSWER_MAX_DISPLAYED_SOURCES
from alvio.db.chunk import delete_chunk_stats_by_connector_credential_pair__no_commit
...
from alvio.db.entities import delete_from_kg_entities_extraction_staging__no_commit
from alvio.db.enums import AccessType
from alvio.db.enums import ConnectorCredentialPairStatus
from alvio.db.feedback import delete_document_feedback_for_documents__no_commit
...
from alvio.db.relationships import (
    delete_from_kg_relationships_extraction_staging__no_commit,
)
from alvio.db.tag import delete_document_tags_for_documents__no_commit
from alvio.db.utils import DocumentRow
from alvio.db.utils import model_to_dict
...
def get_access_info_for_documents(
    ...
    - List of emails of Alvio users with direct access to the doc (includes a "None" element if
