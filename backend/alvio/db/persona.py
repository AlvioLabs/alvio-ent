...
from alvio.configs.app_configs import CURATORS_CANNOT_VIEW_OR_EDIT_NON_OWNED_ASSISTANTS
...
from alvio.db.models import Persona__UserGroup
from alvio.db.models import PersonaLabel
from alvio.db.models import StarterMessage
from alvio.db.models import Tool
from alvio.db.models import User
from alvio.db.models import User__UserGroup
...
def make_persona_private(
    ...
    if group_ids:
        raise NotImplementedError("Alvio MIT does not support private Personas")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_make_persona_private = fetch_versioned_implementation(
            "alvio.db.persona", "make_persona_private"
        )
