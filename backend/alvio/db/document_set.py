...
from alvio.db.models import DocumentSet as DocumentSetDBModel
from alvio.db.models import DocumentSet__ConnectorCredentialPair
from alvio.db.models import DocumentSet__UserGroup
...
def delete_document_set_privacy__no_commit(
    ...
    """No private document sets in Alvio MIT"""
...
def make_doc_set_private(
    ...
    if user_ids or group_ids:
        raise NotImplementedError("Alvio MIT does not support private Document Sets")
...
def insert_document_set(
    ...
    try:
        ...
        from alvio.db.federated import create_federated_connector_document_set_mapping
        ...
        versioned_private_doc_set_fn = fetch_versioned_implementation(
            "alvio.db.document_set", "make_doc_set_private"
        )
...
def update_document_set(
    ...
    try:
        ...
        from alvio.db.federated import create_federated_connector_document_set_mapping
        from alvio.db.models import FederatedConnector__DocumentSet
        from sqlalchemy import delete
...
def mark_document_set_as_to_be_deleted(
    ...
    try:
        ...
        versioned_delete_private_fn = fetch_versioned_implementation(
            "alvio.db.document_set", "delete_document_set_privacy__no_commit"
        )
