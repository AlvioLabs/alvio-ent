...
from alvio.configs.constants import AlvioCallTypes
from alvio.configs.kg_configs import KG_METADATA_TRACKING_THRESHOLD
from alvio.db.engine.sql_engine import get_session_with_current_tenant
from alvio.db.entities import get_kg_entity_by_document
from alvio.db.entity_type import get_entity_types
from alvio.db.kg_config import KGConfigSettings
...
from alvio.db.tag import get_structured_tags_for_document
...
from alvio.kg.models import KGChunkFormat
from alvio.kg.models import KGClassificationInstructions
from alvio.kg.models import KGClassificationResult
from alvio.kg.models import KGDocumentDeepExtractionResults
from alvio.kg.models import KGEnhancedDocumentMetadata
from alvio.kg.models import KGImpliedExtractionResults
from alvio.kg.models import KGMetadataContent
from alvio.kg.utils.formatting_utils import extract_email
from alvio.kg.utils.formatting_utils import get_entity_type
from alvio.kg.utils.formatting_utils import kg_email_processing
from alvio.kg.utils.formatting_utils import make_entity_id
from alvio.kg.utils.formatting_utils import make_relationship_id
from alvio.kg.utils.formatting_utils import make_relationship_type_id
from alvio.kg.vespa.vespa_interactions import get_document_vespa_contents
from alvio.llm.factory import get_default_llms
from alvio.llm.utils import message_to_string
from alvio.prompts.kg_prompts import CALL_CHUNK_PREPROCESSING_PROMPT
from alvio.prompts.kg_prompts import CALL_DOCUMENT_CLASSIFICATION_PROMPT
from alvio.prompts.kg_prompts import GENERAL_CHUNK_PREPROCESSING_PROMPT
from alvio.prompts.kg_prompts import MASTER_EXTRACTION_PROMPT
...
def kg_implied_extraction(
    ...
    document_is_from_call = document_entity_type.lower() in (
        call_type.value.lower() for call_type in AlvioCallTypes
    )
...
def kg_classify_document(
    ...
    if entity_type not in (call_type.value for call_type in AlvioCallTypes):
        return None
...
def kg_deep_extract_chunks(
    ...
    entity_type = get_entity_type(document_entity)
    is_call = entity_type in (call_type.value for call_type in AlvioCallTypes)
