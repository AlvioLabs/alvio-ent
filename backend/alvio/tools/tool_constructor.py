...
from alvio.configs.app_configs import AZURE_DALLE_API_BASE
from alvio.configs.app_configs import AZURE_DALLE_API_KEY
from alvio.configs.app_configs import AZURE_DALLE_API_VERSION
from alvio.configs.app_configs import AZURE_DALLE_DEPLOYMENT_NAME
from alvio.configs.app_configs import IMAGE_MODEL_NAME
from alvio.configs.app_configs import OAUTH_CLIENT_ID
from alvio.configs.app_configs import OAUTH_CLIENT_SECRET
from alvio.configs.app_configs import OKTA_API_TOKEN
from alvio.configs.app_configs import OPENID_CONFIG_URL
from alvio.configs.constants import TMP_DRALPHA_PERSONA_NAME
from alvio.configs.model_configs import GEN_AI_TEMPERATURE
from alvio.context.search.enums import LLMEvaluationType
from alvio.context.search.enums import OptionalSearchSetting
from alvio.context.search.models import InferenceSection
from alvio.context.search.models import RerankingDetails
...
from alvio.db.llm import fetch_existing_llm_providers
from alvio.db.mcp import get_all_mcp_tools_for_server
...
from alvio.llm.interfaces import LLMConfig
from alvio.natural_language_processing.utils import get_tokenizer
from alvio.alviobot.slack.models import SlackContext
from alvio.tools.built_in_tools import get_built_in_tool_by_id
from alvio.tools.models import DynamicSchemaInfo
from alvio.tools.tool import Tool
from alvio.tools.tool_implementations.custom.custom_tool import (
...
from alvio.tools.tool_implementations.mcp.mcp_tool import MCPTool
from alvio.tools.tool_implementations.okta_profile.okta_profile_tool import (
    OktaProfileTool,
)
...
from alvio.tools.utils import compute_all_tool_tokens
from alvio.tools.utils import explicit_tool_calling_supported
from alvio.utils.headers import header_dict_to_header_list
...
class SearchToolConfig(BaseModel):
    ...
    # Use with care, should only be used for AlvioBot in channels with multiple users
        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Internet Search Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Internet search tool requires a search provider API key, please contact your Alvio admin to get it added!"
                    )
