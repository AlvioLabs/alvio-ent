...
from alvio.auth.api_key import get_hashed_api_key_from_request
from alvio.auth.email_utils import send_forgot_password_email
from alvio.auth.email_utils import send_user_verification_email
...
from alvio.auth.schemas import AuthBackend
from alvio.auth.schemas import UserCreate
from alvio.auth.schemas import UserRole
from alvio.auth.schemas import UserUpdateWithRole
from alvio.configs.app_configs import AUTH_BACKEND
from alvio.configs.app_configs import AUTH_COOKIE_EXPIRE_TIME_SECONDS
from alvio.configs.app_configs import AUTH_TYPE
from alvio.configs.app_configs import DISABLE_AUTH
from alvio.configs.app_configs import EMAIL_CONFIGURED
from alvio.configs.app_configs import PASSWORD_MAX_LENGTH
from alvio.configs.app_configs import PASSWORD_MIN_LENGTH
from alvio.configs.app_configs import PASSWORD_REQUIRE_DIGIT
from alvio.configs.app_configs import PASSWORD_REQUIRE_LOWERCASE
from alvio.configs.app_configs import PASSWORD_REQUIRE_SPECIAL_CHAR
from alvio.configs.app_configs import PASSWORD_REQUIRE_UPPERCASE
from alvio.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from alvio.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from alvio.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from alvio.configs.app_configs import TRACK_EXTERNAL_IDP_EXPIRY
...
from alvio.configs.constants import PASSWORD_SPECIAL_CHARS
from alvio.configs.constants import UNNAMED_KEY_PLACEHOLDER
from alvio.db.api_key import fetch_user_for_api_key
from alvio.db.auth import get_access_token_db
from alvio.db.auth import get_default_admin_user_emails
from alvio.db.auth import get_user_count
from alvio.db.auth import get_user_db
from alvio.db.auth import SQLAlchemyUserAdminDB
from alvio.db.engine.async_sql_engine import get_async_session
from alvio.db.engine.async_sql_engine import get_async_session_context_manager
from alvio.db.engine.sql_engine import get_session_with_tenant
from alvio.db.models import AccessToken
from alvio.db.models import OAuthAccount
from alvio.db.models import User
from alvio.db.users import get_user_by_email
from alvio.redis.redis_pool import get_async_redis_connection
...
from alvio.utils.url import add_url_params
...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def create(
        ...
        tenant_id = await fetch_ee_implementation_or_noop(
            "alvio.server.tenants.provisioning",
...
class FastAPIUserWithLogoutRouter(FastAPIUsers[models.UP, models.ID]):
    ...
    def get_refresh_router(
        ...
        from alvio.auth.oauth_refresher import check_and_refresh_oauth_tokens
...
async def optional_user(
    ...
    versioned_fetch_user = fetch_versioned_implementation(
        "alvio.auth.users", "optional_user_"
    )
...
def get_default_admin_user_emails_() -> list[str]:
    # No default seeding available for Alvio MIT
    return []
