...
from alvio.configs.app_configs import REQUEST_TIMEOUT_SECONDS
from alvio.configs.app_configs import SHAREPOINT_CONNECTOR_SIZE_THRESHOLD
...
from alvio.connectors.interfaces import IndexingHeartbeatInterface
...
from alvio.connectors.models import ExternalAccess
...
from alvio.connectors.sharepoint.connector_utils import get_sharepoint_external_access
from alvio.file_processing.extract_file_text import ACCEPTED_IMAGE_FILE_EXTENSIONS
...
from alvio.file_processing.file_validation import EXCLUDED_IMAGE_TYPES
...
class SiteDescriptor(BaseModel):
    ...
    Args:
        url: The base site URL (e.g. https://alvioai.sharepoint.com/sites/sharepoint-tests)
...
def _convert_driveitem_to_document_with_permissions(
    ...
    if not content_bytes:
        ...
        # Note: we don't process Alvio metadata for connectors like Drive & Sharepoint, but could
