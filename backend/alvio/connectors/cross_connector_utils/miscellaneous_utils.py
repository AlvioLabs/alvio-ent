...
from alvio.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
from alvio.configs.constants import IGNORE_FOR_QA
from alvio.connectors.models import BasicExpertInfo
from alvio.connectors.models import AlvioMetadata
from alvio.utils.text_processing import is_valid_email
...
def process_alvio_metadata(
    metadata: dict[str, Any],
) -> tuple[AlvioMetadata, dict[str, Any]]:
    """
    Users may set Alvio metadata and custom tags in text files. https://docs.alvio.io/admin/connectors/official/file
