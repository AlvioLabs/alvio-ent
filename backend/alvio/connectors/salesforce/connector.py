...
from alvio.connectors.interfaces import GenerateDocumentsOutput
...
from alvio.connectors.models import ConnectorCheckpoint
...
from alvio.connectors.salesforce.doc_conversion import convert_sf_object_to_doc
from alvio.connectors.salesforce.doc_conversion import convert_sf_query_result_to_doc
from alvio.connectors.salesforce.doc_conversion import ID_PREFIX
from alvio.connectors.salesforce.alvio_salesforce import AlvioSalesforce
from alvio.connectors.salesforce.salesforce_calls import fetch_all_csvs_in_parallel
from alvio.connectors.salesforce.sqlite_functions import AlvioSalesforceSQLite
from alvio.connectors.salesforce.utils import ACCOUNT_OBJECT_TYPE
from alvio.connectors.salesforce.utils import BASE_DATA_PATH
from alvio.connectors.salesforce.utils import get_sqlite_db_path
from alvio.connectors.salesforce.utils import ID_FIELD
from alvio.connectors.salesforce.utils import MODIFIED_FIELD
from alvio.connectors.salesforce.utils import NAME_FIELD
from alvio.connectors.salesforce.utils import USER_OBJECT_TYPE
...
class SalesforceConnector(LoadConnector, PollConnector, SlimConnector):
    ...
    def __init__(
        ...
        self._sf_client: AlvioSalesforce | None = None
    ...
    def load_credentials(
        ...
        self._sf_client = AlvioSalesforce(
    ...
    @property
    def sf_client(self) -> AlvioSalesforce:
    ...
    def _load_csvs_to_db(
        csv_directory: str, remove_ids: bool, sf_db: AlvioSalesforceSQLite
    ) -> dict[str, str]:
        """
        ...
        # from import alvio.connectors.salesforce.sf_db.sqlite_functions find_ids_by_type
    ...
    #     parent_types: list[str], sf_client: AlvioSalesforce
    # ) -> set[str]:
    ...
    def _full_sync(
        ...
        sf_db = AlvioSalesforceSQLite(os.path.join(temp_dir, "salesforce_db.sqlite"))
        sf_db.connect()
    ...
    def _make_context(
        ...
        for parent_type in parent_types:
            # parent_alvio_sf_type = AlvioSalesforceType(parent_type, sf_client)
            ...
            for child_type, child_relationship in child_types_working.items():
                ...
                # alvio_sf_type = AlvioSalesforceType(child_type, sf_client)
        ...
        for sf_type in all_types:
            # alvio_sf_type = AlvioSalesforceType(sf_type, sf_client)
