...
from alvio.connectors.salesforce.utils import validate_salesforce_id
    ...
    def apply_schema(self) -> None:
        ...
        with self._conn:
            ...
            if cursor.fetchone()[0] == 0:
                AlvioSalesforceSQLite._update_user_email_map(cursor)
            elapsed = time.monotonic() - start
            ...
            with open(csv_download_path, "r", newline="", encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    normalized_record, parent_ids = (
                        AlvioSalesforceSQLite.normalize_record(row, remove_ids)
                    )
                    ...
                    AlvioSalesforceSQLite._update_relationship_tables(
