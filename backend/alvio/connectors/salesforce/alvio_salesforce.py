...
from alvio.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_OBJECTS
from alvio.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_PREFIXES
from alvio.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_SUFFIXES
...
class AlvioSalesforce(Salesforce):
    ...
    def get_child_objects_by_id(
        ...
        while True:
            ...
            if len(child_relationships_batch) >= AlvioSalesforce.SOQL_MAX_SUBQUERIES:
                process_batch = True
            ...
            if process_batch:
                ...
                query = AlvioSalesforce._make_child_objects_by_id_query(
                    object_id,
                    sf_type,
