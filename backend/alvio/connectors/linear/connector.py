...
from alvio.configs.app_configs import LINEAR_CLIENT_ID
from alvio.configs.app_configs import LINEAR_CLIENT_SECRET
...
_NUM_RETRIES = 5
_TIMEOUT = 60
_LINEAR_GRAPHQL_URL = "https://api.linear.io/graphql"
...
class LinearConnector(LoadConnector, PollConnector, OAuthConnector):
    ...
    def oauth_authorization_url(
        ...
        return (
            f"https://linear.io/oauth/authorize"
    ...
    def oauth_code_to_token(
        ...
        response = request_with_retries(
            method="POST",
            url="https://api.linear.io/oauth/token",
            data=data,
            headers=headers,
            backoff=0,
            delay=0.1,
