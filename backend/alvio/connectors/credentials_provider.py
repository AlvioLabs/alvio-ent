...
class AlvioDBCredentialsProvider(
    CredentialsProviderInterface["AlvioDBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "AlvioDBCredentialsProvider":
...
class AlvioStaticCredentialsProvider(
    CredentialsProviderInterface["AlvioStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "AlvioStaticCredentialsProvider":
        return self
