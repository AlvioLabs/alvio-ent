...
from alvio.configs.app_configs import GOOGLE_DRIVE_CONNECTOR_SIZE_THRESHOLD
from alvio.configs.app_configs import INDEX_BATCH_SIZE
from alvio.configs.app_configs import MAX_DRIVE_WORKERS
...
from alvio.connectors.exceptions import InsufficientPermissionsError
from alvio.connectors.google_drive.doc_conversion import build_slim_document
from alvio.connectors.google_drive.doc_conversion import (
    convert_drive_item_to_document,
)
from alvio.connectors.google_drive.doc_conversion import alvio_document_id_from_drive_file
from alvio.connectors.google_drive.doc_conversion import PermissionSyncContext
from alvio.connectors.google_drive.file_retrieval import crawl_folders_for_files
from alvio.connectors.google_drive.file_retrieval import DriveFileFieldType
from alvio.connectors.google_drive.file_retrieval import get_all_files_for_oauth
from alvio.connectors.google_drive.file_retrieval import (
    get_all_files_in_my_drive_and_shared,
)
from alvio.connectors.google_drive.file_retrieval import get_files_in_shared_drive
from alvio.connectors.google_drive.file_retrieval import get_root_folder_id
from alvio.connectors.google_drive.models import DriveRetrievalStage
from alvio.connectors.google_drive.models import GoogleDriveCheckpoint
from alvio.connectors.google_drive.models import GoogleDriveFileType
from alvio.connectors.google_drive.models import RetrievedDriveFile
from alvio.connectors.google_drive.models import StageCompletion
from alvio.connectors.google_utils.google_auth import get_google_creds
from alvio.connectors.google_utils.google_utils import execute_paginated_retrieval
from alvio.connectors.google_utils.google_utils import get_file_owners
from alvio.connectors.google_utils.google_utils import GoogleFields
from alvio.connectors.google_utils.resources import get_admin_service
from alvio.connectors.google_utils.resources import get_drive_service
from alvio.connectors.google_utils.resources import GoogleDriveService
from alvio.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_PRIMARY_ADMIN_KEY,
)
from alvio.connectors.google_utils.shared_constants import MISSING_SCOPES_ERROR_STR
from alvio.connectors.google_utils.shared_constants import ALVIO_SCOPE_INSTRUCTIONS
from alvio.connectors.google_utils.shared_constants import SLIM_BATCH_SIZE
from alvio.connectors.google_utils.shared_constants import USER_FIELDS
from alvio.connectors.interfaces import CheckpointedConnectorWithPermSync
from alvio.connectors.interfaces import CheckpointOutput
from alvio.connectors.interfaces import GenerateSlimDocumentOutput
from alvio.connectors.interfaces import SecondsSinceUnixEpoch
from alvio.connectors.interfaces import SlimConnector
...
from alvio.connectors.models import EntityFailure
from alvio.indexing.indexing_heartbeat import IndexingHeartbeatInterface
from alvio.utils.logger import setup_logger
from alvio.utils.retry_wrapper import retry_builder
from alvio.utils.threadpool_concurrency import parallel_yield
from alvio.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from alvio.utils.threadpool_concurrency import ThreadSafeDict
...
class GoogleDriveConnector(
    ...
    def _checkpointed_retrieval(
        ...
        for file in drive_files:
            document_id = alvio_document_id_from_drive_file(file.drive_file)
            logger.debug(
    ...
    def _load_from_checkpoint(
        ...
        try:
            ...
            if MISSING_SCOPES_ERROR_STR in str(e):
                raise PermissionError(ALVIO_SCOPE_INSTRUCTIONS) from e
            raise e
