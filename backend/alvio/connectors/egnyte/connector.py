...
from alvio.configs.app_configs import EGNYTE_CLIENT_ID
from alvio.configs.app_configs import EGNYTE_CLIENT_SECRET
...
from alvio.connectors.interfaces import OAuthConnector
...
from alvio.file_processing.extract_file_text import detect_encoding
...
from alvio.file_processing.extract_file_text import is_text_file_extension
from alvio.file_processing.extract_file_text import AlvioExtensionType
from alvio.file_processing.extract_file_text import read_text_file
from alvio.utils.logger import setup_logger
from alvio.utils.retry_wrapper import request_with_retries
...
def _process_egnyte_file(
    ...
    if not is_accepted_file_ext(
        extension, AlvioExtensionType.Plain | AlvioExtensionType.Document
    ):
    ...
    if is_text_file_extension(file_name):
        ...
        file_content_raw, file_metadata = read_text_file(
            file_content, encoding=encoding, ignore_alvio_metadata=False
        )
    else:
