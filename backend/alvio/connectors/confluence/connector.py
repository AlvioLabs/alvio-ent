...
from alvio.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from alvio.configs.app_configs import CONFLUENCE_TIMEZONE_OFFSET
from alvio.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from alvio.configs.app_configs import INDEX_BATCH_SIZE
from alvio.configs.constants import DocumentSource
from alvio.connectors.confluence.access import get_all_space_permissions
from alvio.connectors.confluence.access import get_page_restrictions
from alvio.connectors.confluence.alvio_confluence import extract_text_from_confluence_html
from alvio.connectors.confluence.alvio_confluence import AlvioConfluence
from alvio.connectors.confluence.utils import build_confluence_document_id
from alvio.connectors.confluence.utils import convert_attachment_to_content
from alvio.connectors.confluence.utils import datetime_from_string
from alvio.connectors.confluence.utils import process_attachment
from alvio.connectors.confluence.utils import update_param_in_path
from alvio.connectors.confluence.utils import validate_attachment_filetype
...
from alvio.connectors.interfaces import ConnectorCheckpoint
from alvio.connectors.interfaces import ConnectorFailure
from alvio.connectors.interfaces import CredentialsConnector
from alvio.connectors.interfaces import CredentialsProviderInterface
...
from alvio.connectors.models import BasicExpertInfo
...
from alvio.connectors.models import SlimDocument
...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: AlvioConfluence | None = None
        self._low_timeout_confluence_client: AlvioConfluence | None = None
    ...
    @property
    def confluence_client(self) -> AlvioConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> AlvioConfluence:
    ...
    def set_credentials_provider(
        ...
        confluence_client = AlvioConfluence(
        ...
        low_timeout_confluence_client = AlvioConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
