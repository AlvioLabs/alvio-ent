...
from alvio.configs.constants import BlobType
            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"alvio_blob_storage_{int(time.time())}",
                    )
    ...
    def _yield_blob_objects(
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                # Handle image files
                if is_accepted_file_ext(file_ext, AlvioExtensionType.Multimedia):
                ...
                try:
                    ...
                    alvio_metadata, custom_tags = process_alvio_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = alvio_metadata.file_display_name or file_name
                    time_updated = alvio_metadata.doc_updated_at or last_modified
