...
from alvio.configs.chat_configs import ENABLE_CONNECTOR_CLASSIFIER
...
from alvio.prompts.constants import SOURCES_KEY
from alvio.prompts.filter_extration import FILE_SOURCE_WARNING
from alvio.prompts.filter_extration import SOURCE_FILTER_PROMPT
from alvio.prompts.filter_extration import WEB_SOURCE_WARNING
...
def extract_source_filter(
    ...
    def _get_source_filter_messages(
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": "What page from Alvio contains debugging instruction on segfault",
            },
            {
                "role": "assistant",
                "content": json.dumps({SOURCES_KEY: None}),
...
if __name__ == "__main__":
    from alvio.llm.factory import get_default_llms, get_main_llm_from_tuple
