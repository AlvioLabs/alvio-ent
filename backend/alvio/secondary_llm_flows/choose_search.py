...
from alvio.chat.prompt_builder.utils import translate_alvio_msg_to_langchain
...
from alvio.prompts.chat_prompts import AggressiveSearchTemplateParams
from alvio.prompts.chat_prompts import build_aggressive_search_template
from alvio.prompts.chat_prompts import NO_SEARCH
from alvio.prompts.chat_prompts import REQUIRE_SEARCH_HINT
from alvio.prompts.chat_prompts import REQUIRE_SEARCH_SYSTEM_MSG
from alvio.prompts.chat_prompts import SKIP_SEARCH
...
def check_if_need_search_multi_message(
    ...
    prompt_msgs.extend([translate_alvio_msg_to_langchain(msg) for msg in history])
